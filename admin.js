(() => {
  ...
  const STORAGE_KEY = "fplChallengeStudioPhase3Draft";
  const LEGACY_STORAGE_KEYS = ["fplChallengeStudioPhase2Draft", "fplChallengeStudioPhase1Draft"];
