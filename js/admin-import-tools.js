/* FPL Challenge Studio · prompt-tools loader v17.0.0
   Heavy prompt-generation and quality modules now load only when Prompt Studio is opened.
   Validation agreement stays available immediately for Season Certification. */
(() => {
  "use strict";
