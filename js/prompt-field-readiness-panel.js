/* FPL Draft Challenge — Prompt field-readiness panel v1.0.0
...
(() => {
  ...
  window.addEventListener('fpl:prompt-field-readiness-ready',schedule);window.addEventListener('fpl:prompt-library-changed',schedule);window.addEventListener('fpl:prompt-tools-ready',schedule);
  ...
  window.FPL_PROMPT_FIELD_READINESS_PANEL=Object.freeze({version:'1.0.0',render});
})();
