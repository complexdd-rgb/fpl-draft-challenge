/* FPL Challenge Studio — career-overlap wording clarity v1.0.9
...
(() => {
  ...
  function loadQualityExtras() {
    loadStatus("js/prompt-approved-baseline-loader.js?v=1.0.1", "data-approved-prompt-baseline-loader");
