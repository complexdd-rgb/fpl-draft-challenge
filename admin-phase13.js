(() => {
    ...
    setTimeout(() => {
      try {
        ...
        for (const variant of variants) {
          ...
          try {
            const prompt = hydrateVariant(variant, core);
  ...
  function buildCandidateVariants({ includeNameRules, positionMode, cooldown }) {
  ...
  function hydrateVariant(variant, core) {
    const testSource = compileRuleSource(variant.studioRule);
