...
requireText(html, 'js/admin-stage-one.js?v=1.1.0-fastboot', 'Stage One cache bust');
const stageIndex = html.indexOf('js/admin-stage-one.js?v=1.1.0-fastboot');
...
console.log('Studio refresh fast boot verified: legacy markup cannot flash, current workspace boots before heavy scripts, and Prompt Studio scroll is restored after lazy tools load.');
