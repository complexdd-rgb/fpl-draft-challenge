...

{
  ...
  manifest.manifestVersion = '1.4.2-repository-pool';
  manifest.assets.assetManifestRuntime.version = '1.4.2-repository-pool';
  manifest.assets.repositoryCertifiedPromptPool = {
    path: 'js/repository-certified-prompt-pool.js',
    version: '1.0.0'
  };
  manifest.assets.adminStudioFinish.version = '1.0.3-repository-pool';
  manifest.assets.adminDailyGeneratorGuard.version = '1.1.3-repository-pool';
