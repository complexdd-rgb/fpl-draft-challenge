...
for (const path of [packPath, eraPath, readinessPath, panelPath, manifestPath, unlockAuditPath]) {
...
if (readiness.includes('prompt-nationality-context-pack-v1.js')) throw new Error('Retired nationality prompt pack is still auto-loaded by field readiness.');
if (!readiness.includes('nationality-enrichment.js') || !readiness.includes('historical-season-field-manifest.js') || !readiness.includes('historical-prompt-unlock-audit.js') || !readiness.includes('prompt-field-readiness-panel.js')) throw new Error('Readiness metadata extras are not loaded by the readiness mapper.');
