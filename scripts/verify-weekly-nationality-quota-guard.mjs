...
console.log('Weekly nationality invariant verified without polling: Generator v3 locks the reservoir to exactly seven nationality prompts and final day validation requires exactly one per Daily XI.');
