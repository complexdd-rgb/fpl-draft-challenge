...
const countryKey = value => {
  ...
  const aliases = new Map([
    ...
    ['korea republic of', 'south korea'], ['korea republic', 'south korea'], ['republic of korea', 'south korea'],
    ['czech republic', 'czechia'],
    ['bosnia herzegovina', 'bosnia and herzegovina'],
    ['dr congo', 'congo dr'], ['democratic republic of the congo', 'congo dr'], ['congo democratic republic', 'congo dr'],
