...
assert(manifest.assets?.assetManifestRuntime?.version === '4.0.20-future-publish-boundary', 'Asset manifest runtime cache tag is stale.');
...
assert(manifest.assets?.adminDailyGeneratorGuard?.version === '3.1.4-future-publish-boundary', 'Daily generator guard cache tag is stale.');
