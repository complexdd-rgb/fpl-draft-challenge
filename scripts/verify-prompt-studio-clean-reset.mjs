...
assert(manifest.assets?.assetManifestRuntime?.version === '4.0.22-generator-certification', 'Asset manifest runtime cache tag is stale.');
...
assert(manifest.assets?.adminDailyGeneratorGuard?.version === '3.2.0-reservoir-retry', 'Daily generator guard cache tag is stale.');
assert(manifest.assets?.adminGeneratorProductionCertificationV1?.version === '1.0.0', 'Generator production certification cache tag is stale.');
