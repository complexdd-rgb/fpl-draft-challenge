...
assert(manifest.assets?.assetManifestRuntime?.version === '4.0.24-hard-spacing-cert', 'Asset manifest runtime cache tag is stale.');
...
assert(manifest.assets?.adminDailyGeneratorGuard?.version === '3.2.2-hard-spacing', 'Daily generator guard cache tag is stale.');
