...
assert(manifest.assets?.assetManifestRuntime?.version === '4.0.23-exact-nationality', 'Asset manifest runtime cache tag is stale.');
...
assert(manifest.assets?.adminDailyGeneratorGuard?.version === '3.2.1-exact-nationality', 'Daily generator guard cache tag is stale.');
