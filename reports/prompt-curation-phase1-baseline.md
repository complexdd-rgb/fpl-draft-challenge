...
The export also contains Quality-pass prompts well above 150 answer players (at least **281** observed in File Library sampling), so the audit records `151+` as a separate very-broad answer band.
